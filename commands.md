...
printf '{"time_rel":0.0,"step":0,"total_trajectories":0}\n' > learner.jsonl
    ...
    --graph_def=vpnet.pb \
    --cutoff_probability=0.000000 \
    --init_checkpoint=/tmp/az_carcassonne_reuse3_sim800_buffer65536/checkpoint-85 \
    --nn_model=resnet \
    --nn_width=128 \
    --nn_depth=6 \
    --devices=cuda:0 \
...
# az vs mcts
  ...
  --p1_type=az \
  --p2_type=mcts \
  --p1_az_path=/az_carcassonne_0912 \
  --p1_az_checkpoint=108 \
  --p1_az_device=/cuda:0 \
  --p1_max_simulations=800 \
...
# az vs az
  ...
  --p2_az_path=/az_carcassonne_0904 \
  --p2_az_checkpoint=193 \
  --p2_max_simulations=160 \
  --num_games=100 \
  --p1_az_device=/cuda:0 \
  --p2_az_device=/cuda:0 \
